...
class DataCenterEnv(gym.Env):
    ...
    def step(self, action):
        """
        1. Force buy if you cannot reach 120 by hour 24 with full
        buying in all remaining hours.
        2. Disallow sell if it makes it impossible to reach 120
        with full buying in leftover hours.
        3. Apply final action.
        4. If hour=25, end the day, carry up to +50 above daily
        demand.
        """
        ...
        if action < 0:
            ...
            hours_left_after = hours_left - 1 # because wet fix it => disallow sell
